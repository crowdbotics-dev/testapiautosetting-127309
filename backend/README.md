...
## Project Structure
    ...
    ├── testapiautosetting_127309  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127309`
...
2. Clone this repo and `cd testapiautosetting_127309`
